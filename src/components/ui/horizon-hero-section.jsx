...
export const HorizonHeroSection = () => {
  ...
  useEffect(() => {
    const initThree = () => {
      ...
      // Initialize locations after mountains are created
      getLocation();
      ...
      setIsReady(true);
        ...
        setIsReady(true); // Still mark as ready to show fallback
      }
    };
      ...
      if (refs.mountains && refs.mountains.length > 0) {
        refs.mountains.forEach((mountain, i) => {
          ...
          if (progress > 0.7) {
            ...
            // Use baseZ if locations array is not available
            mountain.position.z = refs.locations && refs.locations[i] !== undefined ? refs.locations[i] : mountain.userData.baseZ;
          }
        });
        
        // Update nebula position safely
    ...
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      {!isReady && (
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <div className="text-white/60 text-lg">Loading 3D Environment...</div>
        </div>
      )}
