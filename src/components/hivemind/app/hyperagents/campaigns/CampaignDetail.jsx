...
export default function CampaignDetail({ campaign, loading, onBack, onControl, onApproveAction, onRetryAction, onReconcileAction, busy, executionEnabled = false }) {
  ...
  return <div className="h-full overflow-y-auto bg-[#fbfaf6]">
    ...
    <main className="px-4 sm:px-7 py-6 max-w-6xl">
      ...
      {campaign.requestedChannels.includes(tab) ? <ChannelTab channel={tab} actions={actions} onApprove={onApproveAction} onRetry={onRetryAction} onReconcile={onReconcileAction} busy={busy} /> : null}
