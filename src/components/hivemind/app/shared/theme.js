...
export const API_DEFAULTS = {
  controlPlaneBase: process.env.REACT_APP_CONTROL_PLANE_URL || 'https://api.hivemind.davinciai.eu',
  coreApiBase: process.env.REACT_APP_CORE_API_URL || 'https://hivemind.davinciai.eu',
};
