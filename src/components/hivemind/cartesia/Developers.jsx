          ...
          <div className="px-4 sm:px-8 lg:px-16 py-12 sm:py-16 lg:py-24">
            <div className="text-center mb-10 sm:mb-12">
              <motion.h2
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4 sm:mb-6 font-['Space_Grotesk'] px-2"
              >
            ...
            <div className="grid md:grid-cols-3 gap-4 sm:gap-5">
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="bg-white rounded-xl border border-[#e3e0db] p-5 sm:p-6 flex flex-col hover:border-[#d4d0ca] transition-colors duration-300 shadow-[0_1px_3px_rgba(0,0,0,0.04)]"
              >
                <h3 className="text-xl sm:text-2xl font-bold mb-2 font-['Space_Grotesk']">Individual</h3>
                <div className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 text-[#0a0a0a]">Free</div>
                <p className="text-[#525252] text-xs sm:text-sm mb-6 sm:mb-8 border-b border-[#e3e0db] pb-4 sm:pb-6 flex-1">
                  Perfect for getting started with your personal memory graph.
                </p>
                <ul className="space-y-3 text-xs sm:text-sm text-[#525252] mb-6 sm:mb-8">
                  {[
                    '1M tokens/month',
                    '1 Connector',
                    'Community Support',
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => navigate('/hivemind/login')}
                  className="w-full py-2.5 sm:py-3 rounded-lg border border-[#e3e0db] hover:bg-[#f3f1ec] hover:border-[#d4d0ca] transition-colors font-medium text-[#0a0a0a] bg-white cursor-pointer text-xs sm:text-sm"
                >
                  Get Started
                </motion.button>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-white rounded-xl border-2 border-[#117dff] p-5 sm:p-6 flex flex-col relative overflow-hidden shadow-[0_0_20px_rgba(17,125,255,0.08)]"
              >
                <div className="absolute top-0 right-0 bg-[#117dff] text-white text-[9px] sm:text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-bl-lg">
                  Most Popular
                </div>
                <h3 className="text-xl sm:text-2xl font-bold mb-2 font-['Space_Grotesk']">Pro</h3>
                <div className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 text-[#0a0a0a]">
                  $19<span className="text-lg sm:text-xl font-normal text-[#a3a3a3]">/mo</span>
                </div>
                <p className="text-[#525252] text-xs sm:text-sm mb-6 sm:mb-8 border-b border-[#e3e0db] pb-4 sm:pb-6 flex-1">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => navigate('/hivemind/login')}
                  className="w-full py-2.5 sm:py-3 rounded-[4px] bg-[#117dff] hover:bg-[#0066e0] transition-colors font-semibold text-white text-xs sm:text-sm uppercase tracking-[0.075em] cursor-pointer border-none"
                >
                  Subscribe Now
                </motion.button>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-white rounded-xl border border-[#e3e0db] p-5 sm:p-6 flex flex-col hover:border-[#117dff]/30 transition-colors duration-300 shadow-[0_1px_3px_rgba(0,0,0,0.04)]"
              >
                <h3 className="text-xl sm:text-2xl font-bold mb-2 font-['Space_Grotesk']">Enterprise</h3>
                <div className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 text-[#0a0a0a]">Custom</div>
                <p className="text-[#525252] text-xs sm:text-sm mb-6 sm:mb-8 border-b border-[#e3e0db] pb-4 sm:pb-6 flex-1">
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={() => window.location.href = 'mailto:enterprise@davinciai.eu'}
                  className="w-full py-2.5 sm:py-3 rounded-lg border border-[#e3e0db] hover:bg-[#f3f1ec] hover:border-[#d4d0ca] transition-colors font-medium text-[#0a0a0a] bg-white cursor-pointer text-xs sm:text-sm"
                >
                  Contact Sales
                </motion.button>
